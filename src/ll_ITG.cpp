...
static double ll_Mratio_helper(const arma::vec &p, const arma::mat &N_SA_RA,
                               const arma::mat &N_SA_RB,
                               const arma::mat &N_SB_RA,
                               const arma::mat &N_SB_RB, int nRatings,
                               int nCond, bool fleming) {
...
double ll_Mratio_cpp(const arma::vec &p, const arma::mat &N_SA_RA,
  ...
  return ll_Mratio_helper(p, N_SA_RA, N_SA_RB, N_SB_RA, N_SB_RB, nRatings,
                          nCond, false);
}
